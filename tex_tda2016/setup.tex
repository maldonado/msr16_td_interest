...
\smallsection{(Step 1) SATD extraction}
\todo{Brifly explain how to extract SATD.}
See the detail of...

\smallsection{(Step 2) Identify two versions that introduce and remove technical debt}
...
\smallsection{(Step 3) Measure metrics}
...
\smallsection{(Step 4) Calculate interest}
