...
# Data Load
```{r}
setwd("/Users/kamei/Downloads/msr16_td_interest/")
...
g = ggplot(a1, aes(x=Interest, y=..density.., fill=T), lims(x = c(0,100))) + labs(x="Interest (%)")
g = g + geom_density(alpha = 0.5) + xlim(0, 100) + ylim(0,0.06) + guides(fill=FALSE)
print(g)
...
g = ggplot(a2, aes(x=Interest, y=..density.., fill=T, lims(x = c(0,100)))) + labs(x="Interest (%)")
g = g + geom_density(alpha = 0.5) + xlim(0, 100) + ylim(0,0.04) + guides(fill=FALSE)
print(g)
...
g = ggplot(a3, aes(x=Interest, y=..density.., fill=T), lims(x = c(0,100))) + labs(x="Interest (%)")
g = g + geom_density(alpha = 0.5) + xlim(0, 100) + ylim(0,0.04) + guides(fill=FALSE)
print(g)
