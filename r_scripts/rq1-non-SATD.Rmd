...
print(g)
ggsave(file = "./tex/figures/rq1-ant-non-SATD.pdf", plot = g, width = 8.09, height = 5)
...
g = g + geom_density(alpha = 0.5) + xlim(0, 400) + ylim(0,0.04) + guides(fill=FALSE)
print(g)
ggsave(file = "./tex/figures/rq1-jmeter-non-SATD.pdf", plot = g, width = 8.09, height = 5)
...
g = g + geom_density(alpha = 0.5) + xlim(0, 400) + ylim(0,0.04) + guides(fill=FALSE)
print(g)
ggsave(file = "./tex/figures/rq1-jruby-non-SATD.pdf", plot = g, width = 8.09, height = 5)
}
...
g = g + geom_density(alpha = 0.5) + xlim(0, 400) + ylim(0,0.04) + guides(fill=FALSE)
print(g)
ggsave(file = "./tex/figures/rq1-ant-fanin-non-SATD.pdf", plot = g, width = 8.09, height = 5)
...
g = g + geom_density(alpha = 0.5) + xlim(0, 400) + ylim(0,0.04) + guides(fill=FALSE)
print(g)
ggsave(file = "./tex/figures/rq1-jmeter-fanin-non-SATD.pdf", plot = g, width = 8.09, height = 5)
...
g = g + geom_density(alpha = 0.5) + xlim(0, 400) + ylim(0,0.04) + guides(fill=FALSE)
print(g)
ggsave(file = "./tex/figures/rq1-jruby-fanin-non-SATD.pdf", plot = g, width = 8.09, height = 5)
}
```