...
data.CountInput.all <- cbind(data.CountInput, interest = ((data.CountInput$CountInput_v2 - data.CountInput$CountInput_v1) / data.CountInput$CountInput_v2 * 100))
...
data.CountLine.all <- cbind(data.CountLine, interest = ((data.CountLine$CountLine_v2 - data.CountLine$CountLine_v1) / data.CountLine$CountLine_v2 * 100))
