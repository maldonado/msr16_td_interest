...
Figure \ref{fig:dist} shows that the distribution of interest for the SATD that incurs positive interest. We see that the median of the SATD ranges between 13.6--40.7 and 28.6--50.0 in terms of LOC and Fan-In, respectively.
...
% we have the result for lowest-interest SATD, but the result may not be strong enough for 1st revision. We use that result if we get reviewer's comments as a major revision
